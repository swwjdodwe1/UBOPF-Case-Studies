#SCENARIO 5
#While the baseline scenario features a reasonably balanced distribution, this scenario introduces a deliberate imbalance in the phase-wise demand allocation, while keeping the total demand equal to that of the baseline scenario
...
P_Demand_a = [0, 1500, 0, 0, 0, 900, 1100, 0, 0, 0, 1100, 1100, 0, 0, 900, 0, 0, 1000]   # Active power demanded on phase a of each node
P_Demand_b = [0, 0, 700, 0, 0, 0, 0, 600, 0, 0, 800, 0, 900, 0, 600, 0, 500, 700]        # Active power demanded on phase b of each node
P_Demand_c = [0, 0, 0, 1100, 0, 0, 0, 0, 900, 0, 1400, 700, 0, 1100, 0, 0, 1000, 0]      # Active power demanded on phase c of each node
Q_Demand_a = [0, 130, 0, 0, 0, 50, 40, 0, 0, 0, 100, 90, 0, 0, 50, 0, 0, 90]             # Reactive power demanded on phase a of each node
Q_Demand_b = [0, 0, 20, 0, 0, 0, 0, 60, 0, 0, 40, 0, 100, 0, 80, 0, 100, 90]             # Reactive power demanded on phase b of each node
Q_Demand_c = [0, 0, 0, 20, 0, 0, 0, 0, 90, 0, 100, 150, 0, 60, 0, 0, 30, 0]              # Reactive power demanded on phase c of each node
